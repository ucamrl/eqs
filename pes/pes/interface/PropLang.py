...
class PropLang(Language):
    ...
    def all_operators(self) -> "list[tuple]":
        return list(
            map(self.op_tuple, [("And", "x", "y"), ("Not", "x"),
                                ("Or", "x", "y"), ("Implies", "x", "y")]))
    ...
    def all_rules(self) -> "list[list]":
        ...
        return [
            ...
            ["def_imply_flip", OR(NOT(a), b),
             IM(a, b)],
            ["double_neg_flip", a, NOT(NOT(a))],
            ["assoc_or", OR(a, OR(b, c)),
             OR(OR(a, b), c)],
            ["dist_and_or",
             AND(a, OR(b, c)),
             OR(AND(a, b), AND(a, c))],
    ...
    def get_single_task_exprs(self):
        ...
        s = Or(
            x=Not(x=Not(x=And(x=And(x=True, y=True), y=And(x=True, y='r')))),
            y=Not(x=Not(x='i')))
